  ...
  <div class="search-box hidden" id="search-box">
          ...
          <div class="second-menu-navigation">
            <?php 
              foreach ($asr as $value) {
                echo '<a href="Product.php?type='.$value['type-eng'].'" class="sub-menu-a">'.$value['type-eng'].'</a>';
              }
            ?>
    ...
    <?php 
        foreach($asr as $value){
          ...
          <a href="Product-en.php?type='.$value['type-eng'].'" style="text-decoration: none;"><div class="product-items-text">'.$value['type-eng'].'</div></a>
      </div>';
        }
      ?>
    </div>
