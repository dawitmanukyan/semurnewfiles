...
<html lang="en">
  <head>
    ...
    <title>Ավելացնել Ենթակածեգորյա</title>
    ...
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
          ...
          <div class="content-side">
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                  <?php echo' <a class="nav-main-link" href="Blog.php?h='.$_GET['h'].'"> '; ?>
     ...
     <?php  echo' <form action="Add-subcategories-proccess.php?h='.$_GET['h'].'" method="post" enctype="multipart/form-data" style="padding: 15px;"> ';?>
            ...
            <div class="mb-4">
                <label class="form-label" for="example-file-input">Ենթակածեգորյաի նկարը (Ընտրեք նկարը համակարգչից, ավելացնելու համար)</label>
      ...
      <label class="form-label" for="example-file-input" style="text-align: center;">Ուշադրություն։ Բոլոր ավելացրած կածեգորյաները հայտնվելու են կայքի "Գլխավոր" էջի "կածեգորյաներ" հատվածում նաև կայքի "Մենյու" - ում։</label>
