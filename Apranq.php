  ...
  <div class="header" id="header">
    ...
    >
      ...
      <div class="resp-lang-menu">
        ...
        <a href="Hashvichen.html">EN</a>
        <a href="Hashvichru.html">РУ</a>
      </div>
    </ul>
          ...
          <div class="slider__items">
            <a href="#" class="slider--items--item">
              ...
              <div class="slider--items--item--text">
                <p><a href="Apranq.html">Բանգա</a></p>
              </div>
            </a>

            <a href="Apranq.html" class="slider--items--item">
              <img src="./img/Rectangle 11864.png" alt="">
              <div class="slider--items--item--text">
                <p><a href="Apranq.html">Բանգա</a></p>
              </div>
      ...
      <div class="info">
        ...
        <div class="resp-menu">
          <ul class="resp-menu-ul">
            <li><a href="Apranq.html">Արտադրանք</a></li>
